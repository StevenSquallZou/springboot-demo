...
*/}}
{{- define "springboot-demo-chart.name" -}}
...
*/}}
{{- define "springboot-demo-chart.chart" -}}
...
helm.sh/chart: {{ include "springboot-demo-chart.chart" . }}
{{ include "springboot-demo-chart.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app.kubernetes.io/name: {{ include "springboot-demo-chart.name" . }}
